        ...
        while($lignes = $result->fetch()){
            ...
            <div class="card" style="width: 18rem;">
                ...
                <div class="card-body">
                    ...
                    <a href="../front/connexion.php" title="Envoyer"><input class="btn btn-primary" type="submit" value="Connectez-vous pour donner" /></a>
                </div>
            </div>
            <?php
        }
        ...
        case "detail_projet":
            ...
            <div class="card" style="width: 18rem;">
                ...
                <div class="card-body">
                    ...
                    <br>
                    <a href="../front/connexion.php" class="btn btn-primary">Connectez-Vous pour Donner</a>
                </div>
            </div> 
            <?php
            break;
